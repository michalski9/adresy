                ...
                c => new
                    {
                        ...
                        Godziny = c.String(nullable: false),
                        Obecnosc = c.Boolean(nullable: false),
                        Temat = c.String(nullable: false),
                        Ocena = c.Decimal(nullable: false, precision: 18, scale: 2),
                        Miejsce = c.Int(nullable: false),
                        Prowadzacy = c.String(nullable: false),
                        Stopien_zadowolenia = c.Int(nullable: false),
                    })
                .PrimaryKey(t => t.Id);
